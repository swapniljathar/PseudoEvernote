    ...
    public RegisterView(final JFrame frame) {
        ...
        submitButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch (Control.Register.submitCheck(usernameField.getText(),
                    ...
                    case 2:
                        JOptionPane.showMessageDialog(null, " Username invalid!\t" +
                                        "Username must have only letters,numbers, underscores\tPlease change again! ",
                                "Username Invalid", JOptionPane.WARNING_MESSAGE);
                        break;
                    case 3:
                    ...
                    case 4:
                        ...
                        break;
                    case 1:
                        Control.Register.submit(usernameField.getText(), new String(passwordField.getPassword()),
